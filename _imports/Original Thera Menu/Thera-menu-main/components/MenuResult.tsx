        ...
        <div key={`print-${day?.dayName || dIdx}`} className={`${dIdx > 0 ? 'page-break pt-12' : ''} p-10 max-w-[1000px] mx-auto`}>
          ...
          <div className="flex justify-between items-end border-b-4 border-slate-900 pb-6 mb-8">
            ...
            <div className="text-right">
              ...
              <p className="text-[9px] font-mono text-slate-400 uppercase tracking-widest mt-1">Ref: {Math.random().toString(36).substring(7).toUpperCase()}</p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-12 gap-10">
              ...
              <div className="col-span-4 space-y-6">
                <div className="text-right">
                  ...
                  <p className="text-sm font-bold uppercase">{plan.preparedBy || "Dr. Enrique, RD"}</p>
                  <p className="text-[9px] font-mono text-slate-500">Chief Clinical Dietitian</p>
                </div>
                <div className="text-right">
  ...
  return (
    <div className="space-y-8 animate-slide-in">
      ...
      <div className="no-print max-w-5xl mx-auto space-y-8">
          ...
          <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div className="space-y-2">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-[10px] font-mono text-slate-400 uppercase tracking-[0.3em]">ID: {Math.random().toString(36).substring(7).toUpperCase()}</span>
              </div>
        ...
        {/* Day Selector */}
        <div className="flex p-1 bg-white rounded-xl border border-slate-200 shadow-sm overflow-x-auto scrollbar-hide">
          {plan.days.map((day, idx) => (
            <button
              key={day.dayName}
              onClick={() => setActiveDayIndex(idx)}
              className={`flex-1 min-w-[120px] py-3 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all ${
                activeDayIndex === idx 
